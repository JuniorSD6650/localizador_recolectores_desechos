...
const RegisterCalleModal = ({ show, onClose, onRegister }) => {
    ...
    // Estado para almacenar las zonas que llegan desde la API
    const [zonas, setZonas] = useState([]);

    // Al montar el componente, obtenemos la lista de zonas
    useEffect(() => {
    ...
    const handleRegister = async () => {
        try {
            ...
            if (response.ok) {
                const newCalle = await response.json();
                showSuccessAlert('Éxito', 'Calle registrada correctamente');
                onRegister(newCalle);
                onClose();
            } else {
                showErrorAlert('Error', 'No se pudo registrar la calle');
            }
        } catch (error) {
...
RegisterCalleModal.propTypes = {
    show: PropTypes.bool.isRequired,
    onClose: PropTypes.func.isRequired,
    onRegister: PropTypes.func.isRequired,
};

export default RegisterCalleModal;
